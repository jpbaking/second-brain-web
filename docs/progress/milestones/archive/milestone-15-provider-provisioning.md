# Milestone 15 - Declarative Provider Provisioning (COMPLETE)

> Activated by the principal on 2026-07-11. Design: [provider-provisioning.md](../../design/provider-provisioning.md)
> — **revision 3 (YAML-only, document-ordered)**: the principal does not want to manage providers
