...
- [x] m44-01: Expand the runtime image with common filesystem, archive, text, build, database, process, network, and scripting tools; expose Debian's `fdfind` as `fd`; enforce availability with a build-time smoke check.
