...
- [ ] **m5b-01** — Compaction data model: Update `chat_sessions` schema to support storing a `compaction_summary` text and `compacted_at` timestamp. Add `compaction` to the valid `chat_events` types.
